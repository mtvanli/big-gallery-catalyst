      ...
      >
        <FocusTrap active={isExpanded}>
          <div className="relative">
            <div
              className={cn(
                'group flex min-h-[92px] items-center justify-between gap-6 overflow-hidden px-6 2xl:container sm:px-10 lg:gap-8 lg:px-12 2xl:mx-auto 2xl:px-0',
                className,
              )}
              {...props}
            >
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    className={cn(
      'group/button flex w-full items-center justify-between gap-1 p-3 font-semibold hover:text-blue-primary focus:outline-none     ',
      className,
    )}
    ref={ref}
    {...props}
...
>(({ children, className, ...props }, ref) => {
  ...
  return (
    <NavigationMenuPrimitive.Link
      className={cn(
        'flex justify-between p-3 font-semibold hover:text-blue-primary focus:outline-none ',
        className,
      )}
  ...
  ({ children, className, onClick, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          'group p-3 hover:text-blue-primary focus:outline-none     ',
          className,
        )}
        onClick={(e) => {
          onClick?.(e);
