  ...
  ({ children, className, onClick, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          'inline-flex h-12 w-12 items-center justify-center focus:outline-none     ',
          isHidden && 'hidden',
          className,
        )}
        onClick={(e) => {
  ...
  ({ children, className, isSelected, ...props }, ref) => {
    return (
      <button
        ...
        className={cn(
          "h-7 w-7 p-0.5 after:block after:h-0.5 after:w-full after:bg-gray-400 after:content-[''] focus:outline-none     ",
