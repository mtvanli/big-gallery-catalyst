...
>(({ className, children, ...props }, ref) => (
  <RadioGroupPrimitive.Item
    className={cn(
      'border-2 px-6 py-2.5 font-semibold text-black hover:border-blue-primary focus:outline-none      disabled:border-gray-100 disabled:text-gray-400 disabled:hover:border-gray-100',
