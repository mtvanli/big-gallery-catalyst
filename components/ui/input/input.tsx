...
const inputVariants = cva(
  'peer    w-full border-2 border-gray-200 py-2.5 px-4 text-base placeholder:text-gray-500 focus:border-blue-primary focus:outline-none   hover:border-blue-primary disabled:bg-gray-100 disabled:hover:border-gray-200',
  {
    variants: {
      variant: {
        success:
